...
Status: Partially implemented — Phase 1, the Phase 2 release-safety scope, and the first Phase 3 typed IPC slices are complete; screenshot archival and Phases 4–5 remain planned.
...
- Migrate project, knowledge, Janus, LLM, Office, agent, checkpoint, and settings domains.
