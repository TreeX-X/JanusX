...
| Project launcher | `components/ProjectLauncher.tsx`, `ProjectSettings.tsx`, `ProjectRunningList.tsx`, `ProjectConfigForm/*`, `services/project.ts` | detect/configure/run projects |
