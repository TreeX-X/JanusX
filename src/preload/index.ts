...
const llmAPI: LlmAPI = {
  ...
  getTerminalBindings: () => ipcRenderer.invoke(LLM_CHANNELS.getTerminalBindings),
  setTerminalBinding: (consumer, binding) => ipcRenderer.invoke(LLM_CHANNELS.setTerminalBinding, consumer, binding),
